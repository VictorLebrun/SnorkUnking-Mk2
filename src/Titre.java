        ...
        while(true){	
    		...
    		if (compteurlancement<1) {
    		    ...
    		    StdDraw.picture(X_MAX/2, i,"bouteille.png",50*SW,50*SH);
    		    	...
    		    	StdDraw.picture(X_MAX/2, i,"kevinexplosionlarge.gif", 350*SW, 350*SH);
    		    	StdDraw.picture(X_MAX/2, Y_MAX/2,"ocean.jpg",640*SW,360*SH);
    		    	StdDraw.picture(X_MAX/2, Y_MAX/2,"kevinexplosionlarge.gif", 350*SW, 350*SH);	
    				...
    				StdDraw.picture(X_MAX/2, Y_MAX/2,"SnorkUnkingLogo.png", 380*SW, 240*SH);
    				StdDraw.show(10/(int)(SH));
    				StdDraw.picture(X_MAX/4, 3*Y_MAX/4,"kevinexplosionlarge.gif", 350*SW, 350*SH);
    				StdDraw.show(10/(int)(SH)); 
    				StdDraw.picture(X_MAX/4, Y_MAX/4,"kevinexplosionlarge.gif", 350*SW, 350*SH);
    				StdDraw.show(10/(int)(SH)); 
    				StdDraw.picture(3*X_MAX/4, 3*Y_MAX/4,"kevinexplosionlarge.gif", 350*SW, 350*SH);
    				StdDraw.show(10/(int)(SH)); 
    				StdDraw.picture(3*X_MAX/4, Y_MAX/4,"kevinexplosionlarge.gif", 350*SW, 350*SH);
    				StdDraw.show(10/(int)(SH)); }
